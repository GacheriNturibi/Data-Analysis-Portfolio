...
I explored this competition data to get a good understanding of the dataset. The EDA is detailed and many visualizations are included. This version also includes modeling. 

* Lasso regressions performs best with a cross validation RMSE-score of 0.1121. There is multicolinearity among the variables, hence this was expected. Lasso does not select a substantial number of the available variables in its model, as it is supposed to do.
...
```{r}
setwd("C:/Users/gache/Desktop/Github Projects/house-prices-advanced-regression-techniques")
...
The two houses with really big living areas and low SalePrices seem like outliers at the moment (houses 524 and 1299, see labels in graph). I will however, not drop them yet without exploring the data further. For instance, a low score on the Overall Quality could explain a low price. However, as you can see below, these two houses also score maximum points on Overall Quality. Therefore, I will keep houses 1299 and 524 in mind as prime candidates to drop as outliers.
